...
class HospitalAddressEntity extends Equatable {
  final String street;
  final String city;
  final String state;
...
class HospitalLocationEntity extends Equatable {
  final double latitude;
  final double longitude;

  const HospitalLocationEntity({
...
class HospitalEntity extends Equatable {
  ...
  final HospitalAddressEntity address;
  final HospitalLocationEntity? location;
